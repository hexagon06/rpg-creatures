      ...
      <div class="flex gap-2">
        <input-wrapper label="STR">
          <input id="input-strength"
                 v-model.number="creature.strength"
                 placeholder="10"
                 number
                 @keypress="isNumber"
                 class="w-9">
        ...
        <input-wrapper label="DEX">
          <input id="input-dexterity"
                 v-model.number="creature.dexterity"
                 placeholder="10"
                 number
                 @keypress="isNumber"
                 class="w-9">
        ...
        <input-wrapper label="CON">
          <input id="input-constitution"
                 v-model.number="creature.constitution"
                 placeholder="10"
                 number
                 @keypress="isNumber"
                 class="w-9">
        ...
        <input-wrapper label="INT">
          <input id="input-intelligence"
                 v-model.number="creature.intelligence"
                 placeholder="10"
                 number
                 @keypress="isNumber"
                 class="w-9">
        ...
        <input-wrapper label="WIS">
          <input id="input-wisdom"
                 v-model.number="creature.wisdom"
                 placeholder="10"
                 number
                 @keypress="isNumber"
                 class="w-9">
        ...
        <input-wrapper label="CHA">
          <input id="input-charisma"
                 v-model.number="creature.charisma"
                 placeholder="10"
                 number
                 @keypress="isNumber"
                 class="w-9">
